...
# # Indentierung und if statements
...
# Antwort:\
# Option 1 ist von den drei Optionen, die übersichtlichste, da man den Codeblock des if statements von dem weiteren Code leicht unterscheiden kann ohne auf geschweifte Klammern achten zu müssen.
# 
...
# Durch Indentierung, bzw. "Einrücken". 
...
# 
# ```
# Hiermit hätten wir auch bereits geklärt wie if statements Funktionieren
# ```Python
# if BEDINGUNG:
...
# ```
# 
# Man muss mit Indentierung konsequent sein und korrekt indentieren. Jedes whitespace bzw. jeder tab zählt.
