...
# Jemand hat ein Programm in C geschrieben und offenbar ist etwas schief gelaufen. Die Einrückung wurde gelöscht. Ihre Aufgabe war es, das Programm in Python umzuschreiben, damit man einen Performancevergleich der beiden Programme durchführen kann. Dass die Einrückung verschwunden ist, macht Ihr Leben sicherlich nicht einfacher.
